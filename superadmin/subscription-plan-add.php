...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($plan_name === '') {
        ...
        $check = $conn->prepare("SELECT id FROM subscription_plans WHERE plan_name = ? LIMIT 1");
        if ($check) {
...
$currentPage = 'subscription-plan-add';
?>
<!doctype html>
<html lang="en">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="plan_name" class="form-control"
                                                    value="<?php echo h($_POST['plan_name'] ?? ''); ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" name="price" class="form-control"
                                                    value="<?php echo h($_POST['price'] ?? '0.00'); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="billing_cycle" class="form-select" required>
                                                    ...
                                                    <option value="half_yearly" <?php echo (($_POST['billing_cycle'] ?? '') === 'half_yearly') ? 'selected' : ''; ?>>Half Yearly</option>
                                                    <option value="yearly" <?php echo (($_POST['billing_cycle'] ?? '') === 'yearly') ? 'selected' : ''; ?>>Yearly</option>
                                                    <option value="lifetime" <?php echo (($_POST['billing_cycle'] ?? '') === 'lifetime') ? 'selected' : ''; ?>>Lifetime</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="0" name="max_branches" class="form-control"
                                                    value="<?php echo h($_POST['max_branches'] ?? '1'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="0" name="max_users" class="form-control"
                                                    value="<?php echo h($_POST['max_users'] ?? '5'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" name="max_invoices_per_month" class="form-control"
                                            value="<?php echo h($_POST['max_invoices_per_month'] ?? ''); ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="inventory_module" name="inventory_module"
                                            <?php echo isset($_POST['inventory_module']) || !$_POST ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="sales_module" name="sales_module"
                                            <?php echo isset($_POST['sales_module']) || !$_POST ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="service_module" name="service_module"
                                            <?php echo isset($_POST['service_module']) || !$_POST ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="accounts_module" name="accounts_module"
                                            <?php echo isset($_POST['accounts_module']) || !$_POST ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="reports_module" name="reports_module"
                                            <?php echo isset($_POST['reports_module']) || !$_POST ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="status" name="status"
                                            <?php echo isset($_POST['status']) || !$_POST ? 'checked' : ''; ?>>
